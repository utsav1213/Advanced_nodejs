...
program.command('add').description('Add a new expenses').requiredOption("--description <desc>", "Description of the expense")
    .requiredOption("--amount <amt>", "Amount of the expense").action((options) => {
    ...
    program
      ...
      .requiredOption("--id <id>", "ID of the expense to update").option("--description <desc>", "New description")
        .option("--amount <amt>", "New amount").action((option) => {
